(function () {
  ...
  var contractSelect = document.getElementById("hcContractSelect");
  ...
  function bindContractSelect() {
    if (!contractSelect) return;
    if (selectedContractInput) selectedContractInput.value = contractSelect.value;
    if (manualContract) manualContract.value = contractSelect.value;
    ...
    contractSelect.addEventListener("change", function () {
      ...
      nextUrl.searchParams.set("contract", contractId);
