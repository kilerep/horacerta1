...
from . import event_proposal, event_proposal_open, views
...
urlpatterns = [
    ...
    path("me/servicos/<uuid:job_id>/proposta-evento/", event_proposal_open.open_service_event_proposal, name="service_event_proposal_detail"),
